...
sequenceDiagram
  ...
  participant Z as buildApplicationSchema(t)

  U->>Lang: Switch to "ar"
  Lang->>I18N: i18n.changeLanguage("ar")
  I18N-->>Lang: language changed
  Lang->>document: dir="rtl"
  W->>I18N: t function updates
  W->>Z: schema = buildApplicationSchema(t)
  Z-->>W: Zod schema with Arabic messages
